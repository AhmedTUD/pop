    ...
    data.forEach(item => {
        ...
        if (dataType === 'categories') {
            row.innerHTML = `
                ...
                <td>
                    <button class="admin-btn" style="height: 35px; min-width: 60px;" onclick="editItem('${dataType}', ${item.id}, '${item.name}')" title="Edit">
                        <span class="btn-icon" style="font-size: 14px; margin-bottom: 2px;">✏️</span>
                        <span class="btn-text" style="font-size: 9px;">Edit</span>
                    </button>
                    <button class="admin-btn admin-btn-logout" style="height: 35px; min-width: 60px;" onclick="deleteItem('${dataType}', ${item.id})" title="Delete">
                        <span class="btn-icon" style="font-size: 14px; margin-bottom: 2px;">🗑️</span>
                        <span class="btn-text" style="font-size: 9px;">Delete</span>
                    </button>
                </td>
            `;
            ...
            row.innerHTML = `
                ...
                <td>${formatDate(item.created_date)}</td>
                <td>
                    <button class="admin-btn" style="height: 35px; min-width: 60px;" onclick="editItem('${dataType}', ${item.id}, '${item.name}', '${item.category}', '${item.model || ''}')" title="Edit">
                        <span class="btn-icon" style="font-size: 14px; margin-bottom: 2px;">✏️</span>
                        <span class="btn-text" style="font-size: 9px;">Edit</span>
                    </button>
                    <button class="admin-btn admin-btn-logout" style="height: 35px; min-width: 60px;" onclick="deleteItem('${dataType}', ${item.id})" title="Delete">
            ...
            row.innerHTML = `
                ...
                <td>${formatDate(item.created_date)}</td>
                <td>
                    <button class="admin-btn" style="height: 35px; min-width: 60px;" onclick="editItem('${dataType}', ${item.id}, '${item.name}', '${item.category}')" title="Edit">
                        <span class="btn-icon" style="font-size: 14px; margin-bottom: 2px;">✏️</span>
                        <span class="btn-text" style="font-size: 9px;">Edit</span>
                    </button>
                    <button class="admin-btn admin-btn-logout" style="height: 35px; min-width: 60px;" onclick="deleteItem('${dataType}', ${item.id})" title="Delete">
